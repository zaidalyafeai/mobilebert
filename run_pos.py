...
class PosProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        :return:
        """
        return ['[PAD]', 'ADJ', 'ADP', 'ADV', 'AUX', 'CONJ', 'DET', 'INTJ', 'NOUN', 'NUM', 'PART', 'PRON', 'PROPN', 'PUNCT', 'SYM', 'VERB', 'X', '[CLS]', '[SEP]']
...
def main(_):
    ...
    if FLAGS.do_eval:
        ...
        p,r,f = metrics.calculate_pos(confusion_matrix,len(label_list)-1)
        logging.info("***********************************************")
